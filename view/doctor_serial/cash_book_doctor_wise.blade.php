...
@section('content')
    ...
    <h1>CashBook Report on Doctor Wise</h1>
    <hr>
        <div class="row">
            <div class="col-sm-12">
                {!! Form::open([
                        'url'           => 'doctor-serial/cash-book-doctor-wise-details',
                        'method'        => 'get',
                        'target'        => '_blank',
                ...
                <div class="form-group">
                    <div class="col-sm-offset-1 col-sm-6 text-center">
                        {!! Form::button('Cash Doctor Wise Details', ['type' => 'submit', 'class' => 'btn btn-success']) !!}
